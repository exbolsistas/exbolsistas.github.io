...
## Redes de pesquisadores e profissionais no exterior

Aqui listamos links que podem ajudar bolsistas, ex-bolsitas e outras partes interessadas a encontrar redes e comunidades que integram pessoas das diásporas brasileiras de educação, ciência, tecnologia e/ou inovação (ECT&I).
...
[Mapeamento da Rede Sabiá]: https://www.redesabia.org/mapeamento-das-comunidades-academicas-brasileiras-no-exterior/

Lista coletada pelo Núcleo:

| País/Cidade/Região           | Rede e/ou comunidade                     | Notas                                                                                          |
| ---------------------------- | ---------------------------------------- | ---------------------------------------------------------------------------------------------- |
| 🌐 Global                   | [Rede Sabiá](https://redesabia.org/)     | Articulação de comunidades brasileiras de educação, ciência, tecnologia e inovação no exterior |
| :flag_de: Alemanha           | [Apoena](https://redeapoena.org)         |                                                                                                |
